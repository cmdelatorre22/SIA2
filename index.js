...
const validateInputs = () => {
    ...
    if(passwordValue === '') {
        ...
        setError(password, 'Password must be at least 8 to 20 characters.')
    } else {
        setSuccess(password);
    }
    ...
    if(lastnameValue === '') {
        setError(lastname, 'Surname/Last Name is required');
    } else {
        setSuccess(lastname);
    }
    if(givennameValue === '') {
        setError(givenname, 'Given Name is required');
    } else {
